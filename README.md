...
1. Faz o clone deste repositório:
   ...
   ```
2. Abre o projeto na tua IDE (ex: Android Studio, VS Code).
3. Conecta o teu dispositivo móvel via USB (com o modo *Developer / USB Debugging* ativado).
4. Compila e instala a aplicação no dispositivo. 
*Nota: É recomendado testar num telemóvel físico real para garantir o correto funcionamento do giroscópio/acelerómetro.*
